      ...
      <div slot="api">
        <api-table name="md-select">
          <md-table slot="properties">
            ...
            <md-table-body>
              ...
              <md-table-row>
                ...
                <md-table-cell><code>Boolean</code></md-table-cell>
                <md-table-cell>Changes select to multiple. Accepts array for v-model. Default <code>false</code></md-table-cell>
              </md-table-row>

              <md-table-row>
                <md-table-cell>items</md-table-cell>
                <md-table-cell><code>Array</code></md-table-cell>
                <md-table-cell>The array of items.</md-table-cell>
              </md-table-row>

              <md-table-row>
                <md-table-cell>value-key</md-table-cell>
                <md-table-cell><code>String</code></md-table-cell>
                <md-table-cell>Key name for value. Use with items.</md-table-cell>
              </md-table-row>
          ...
          <md-table slot="scoped slots">
            ...
            <md-table-body>
              <md-table-row>
                <md-table-cell>default</md-table-cell>
                <md-table-cell>Options template.</md-table-cell>
              </md-table-row>

              <md-table-row>
                <md-table-cell>selection</md-table-cell>
                <md-table-cell>Selected value template. Optional.</md-table-cell>
              </md-table-row>
            </md-table-body>
          </md-table>
        </api-table>

        <api-table name="md-option (optional)">
      ...
      <div slot="example">
        <example-box card-title="Default">
          <div slot="demo">
            <div class="field-group">
              <md-select label="Movie" name="movie" id="movie" v-model="movie">
              ...
              <md-select label="Country" name="country" id="country" v-model="country">
              ...
              <md-select label="Font" name="font" id="font" v-model="font">
              ...
              <md-select label="Food" name="food" id="food" v-model="food">
        ...
        <example-box card-title="Multiple">
          <div class="multiple" slot="demo">
            <div class="field-group">
              <md-select label="Users" multiple v-model="users">
